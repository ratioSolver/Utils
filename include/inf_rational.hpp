...
namespace utils
{
  ...
  public:
    ...
    explicit inf_rational(INTEGER_TYPE nun) : rat(nun) {}
    explicit inf_rational(const rational &rat) : rat(rat) {}
    explicit inf_rational(INTEGER_TYPE nun, INTEGER_TYPE den) : rat(nun, den) {}
    explicit inf_rational(const rational &rat, INTEGER_TYPE inf) : rat(rat), inf(inf) {}
    ...
    inline bool operator!=(const INTEGER_TYPE &rhs) const noexcept { return rat != rhs || !is_zero(inf); };
    inline bool operator<(const INTEGER_TYPE &rhs) const noexcept { return rat < rhs || (rat == rhs && is_negative(inf)); };
    inline bool operator<=(const INTEGER_TYPE &rhs) const noexcept { return rat < rhs || (rat == rhs && is_negative_or_zero(inf)); };
    inline bool operator==(const INTEGER_TYPE &rhs) const noexcept { return rat == rhs && is_zero(inf); };
    inline bool operator>=(const INTEGER_TYPE &rhs) const noexcept { return rat > rhs || (rat == rhs && is_positive_or_zero(inf)); };
    inline bool operator>(const INTEGER_TYPE &rhs) const noexcept { return rat > rhs || (rat == rhs && is_positive(inf)); };
    ...
    inline inf_rational operator+(const INTEGER_TYPE &rhs) const noexcept { return inf_rational(rat + rhs, inf); };
    inline inf_rational operator-(const INTEGER_TYPE &rhs) const noexcept { return inf_rational(rat - rhs, inf); };
    inline inf_rational operator*(const INTEGER_TYPE &rhs) const noexcept { return inf_rational(rat * rhs, inf * rhs); };
    inline inf_rational operator/(const INTEGER_TYPE &rhs) const noexcept { return inf_rational(rat / rhs, inf / rhs); };
    ...
    inline friend inf_rational operator+(const INTEGER_TYPE &lhs, const inf_rational &rhs) noexcept { return inf_rational(lhs + rhs.rat, rhs.inf); }
    inline friend inf_rational operator-(const INTEGER_TYPE &lhs, const inf_rational &rhs) noexcept { return inf_rational(lhs - rhs.rat, rhs.inf); }
    inline friend inf_rational operator*(const INTEGER_TYPE &lhs, const inf_rational &rhs) noexcept { return inf_rational(lhs * rhs.rat, lhs * rhs.inf); }
    inline friend inf_rational operator/(const INTEGER_TYPE &lhs, const inf_rational &rhs) noexcept { return inf_rational(lhs / rhs.rat, lhs / rhs.inf); }
